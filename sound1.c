...
static inline unsigned char next_rnd()
{
	return sin[getRand()%SO(sin)];
}

static inline unsigned char next_sin()
{
...
static unsigned char t8=0;
static unsigned char barevent=0;
static unsigned char bars=0;

static unsigned char apreggiobase[] =	{ 3, 4, 4, 5 };
static unsigned char bassdrum[] =	{ 1, 0, 1, 1 };
static unsigned char snare[] = 	{ 1, 0, 0, 1 };
static unsigned char pc = 0;
static unsigned char apreggiocnt = 1;
